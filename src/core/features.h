...
BEGIN_FEATURE_STRING()
	...
	FEATURE_STR_ENTRY(HAS_MILES_EVENTS) +
	FEATURE_STR_ENTRY(ADVANCED_MODEL_PREVIEW) +
	FEATURE_STR_ENTRY(HAS_BRIDGE) +
	FEATURE_STR_ENTRY(PREVIEW_FIRST_PERSON)
END_FEATURE_STRING();

#undef BEGIN_FEATURE_STRING
#undef FEATURE_STR_ENTRY
#undef END_FEATURE_STRING
